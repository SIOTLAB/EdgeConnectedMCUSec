...
::                            STiRoT bootpath
:: ==============================================================================
set stirot_appli=LED_State_Toggle_enc_sign.hex
set stirot_appli_bin=LED_State_Toggle_Secure.bin
set isFullSecure=0
...
set appli_non_secure=LED_State_Toggle_NonSecure.bin
set appli_non_secure_path=%~dp0/../NonSecure\Debug\
set appli_assembly=LED_State_Toggle_assembled.bin
